...
<div id="item_form" class="page-main">
	<h2>상품 수정</h2>
	<form:form modelAttribute="itemVO" action="admin_modify.do" id="item_modify" enctype="multipart/form-data">
		...
		<ul>
			...
			<li>
				...
				<span>업로드된 파일명 : ${itemVO.photo_name1}</span>
			...
			<li>
				...
				<span>업로드된 파일명 : ${itemVO.photo_name2}</span>
