...
public interface TalkMapper {
	...
	//채팅방 생성
	@Insert("INSERT INTO sptalkroom (talkroom_num,basic_name) "
		  + "VALUES (#{talkroom_num},#{basic_name})")
	public void insertTalkRoom(TalkRoomVO talkRoomVO);
	
	//채팅방 멤버 등록
	@Insert("INSERT INTO sptalk_member (talkroom_num,room_name,mem_num) "
		  + "VALUES (#{talkroom_num},#{room_name},#{mem_num})")
	...
	//읽지 않은 채팅 기록 저장
	@Insert("INSERT INTO sptalk_read(talkroom_num,talk_num,mem_num) "
		  + "VALUES(#{talkroom_num},#{talk_num},#{mem_num})")
